...
Welcome to the UniJS documentation. UniJS is a library designed to bridge Unity WebGL builds and JavaScript, providing a more efficient way to interact with your game from a web environment than the standard `SendMessage`.
...
- **High-Performance Interop**: Direct communication between JS and Unity.
- **Unity-like JS API**: Familiar classes like `GameObject`, `Transform`, `Rigidbody`, and `Time` in JavaScript.
